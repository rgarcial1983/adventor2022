    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedReader br = Files.newBufferedReader(Paths.get("D:\\entrada.txt"))){
            ...
            while ((linea = br.readLine()) != null) {
                ...
                Integer desde = Integer.valueOf(fila[3]);
                Integer hasta = Integer.valueOf(fila[5]);

                for (int i = 0; i < mover; i++) {
                    // Cogemos la letra a mover
                    String temp = mapaPilas.get(desde).peek();
                    // La borramos de la pila origen
                    mapaPilas.get(desde).pop();
                    // La agregamos a la pila destino
                    mapaPilas.get(hasta).push(temp);
                }
            }
